...
parser.add_argument("-wd", "--winddir", type=float, default=270.,\
  help="Wind direction in degrees relative to grid: 0 equals north (-y), 180 south (+y), 270 west (+x). Default = 270.")
...
z, Umag = np.loadtxt('umag_profil.dat', usecols=(0,1), unpack=True)
